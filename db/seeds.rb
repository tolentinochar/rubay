...
Item.create(name:'D', desc:'Dd', unit_price:50, qty:40, qty_sold:0 )
Item.create(name:'E', desc:'Ee', unit_price:150, qty:40, qty_sold:0 )
Item.create(name:'F', desc:'Ff', unit_price:510, qty:40, qty_sold:0 )
...
Item.create(name:'Aldnoah Zero', desc:'I use an image url for my image!! I am so special!', unit_price:400, qty:40, qty_sold:0, img_url:'http://foolhardi.com/wp-content/uploads/2014/10/Aldnoah.Zero-Mecha-HD-Wallpaper.jpg' )
Item.create(name:'April', desc:'Trying out stuff.', unit_price:500.55, qty:23, qty_sold:10, img_url:'http://33.media.tumblr.com/a1fb76eb3a1aaa0a5ac8470d4db4b884/tumblr_ndlyqqDH7F1sang2co1_500.gif' )
